...
- **Communications & Networking Laboratory (CNL), Yonsei University**, Jul. 2024 – Present
  ...
  - **Graduate Research Assistant**, Mar. 2025 – Present (Advisor: Prof. Jong-Moon Chung)
    ...
    - Contributed to a multi-agent reinforcement learning-based handover management study for LEO satellite networks by building the network simulator and conducting large-scale performance evaluation.
...
- **Robotic & Mobile Networks Laboratory (RAMO), Yonsei University**, Jan. 2024 – Jun. 2024
  ...
  - Built a multi-access edge computing (MEC) testbed that offloaded robot vision inference to an edge/core server over a private 5G network for ultra-reliable low-latency communication (URLLC) in remote robot control.
...
- **Adaptive UAV–MEC Collaborative Inference for Urban Traffic Monitoring**, Mar. 2026 – Jul. 2026
  ...
  - Built a UAV–MEC split-computing pipeline for real-time traffic-monitoring object detection that remains robust under poor wireless channels.
  - Published the results as a first-author conference paper.
- **UAV Aerial Imagery-Based Road Object Detection for Dynamic Thematic Map Generation**, Jan. 2025 – Present
  - Research Assistant, Yonsei University; KAIA-funded national R&D project under MOLIT
  - Built a deep learning-based system for real-time recognition of road objects from UAV aerial imagery.
  - Improved detection of small, occluded, and low-light objects through tiling-based augmentation and misalignment-tolerant EO/IR sensor fusion, meeting accuracy and latency targets in official certification testing.
